...
class DomainsRelationManager extends RelationManager
{
    ...
    public function form(Form $form): Form
    {
        ...
        $schema = DomainResource::form(Form::make($this))->getComponents();
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('registrar')->searchable()->sortable(),
                Tables\Columns\TextColumn::make('expiry_date')->date('d-M-Y')->sortable(),
            ])
            ->filters([
                //
            ])
